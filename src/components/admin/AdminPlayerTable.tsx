...
const COLUMN_DEFINITIONS = [
  ...
  { key: 'createdAt', label: 'Creation Date', width: '140px' },
  ...
  { key: 'team_status', label: 'Team Status', width: '130px' },
  ...
  { key: 'video_report_1', label: 'Video Report 1', width: '140px' },
  { key: 'video_report_2', label: 'Video Report 2', width: '140px' },
  { key: 'video_report_3', label: 'Video Report 3', width: '140px' },
  { key: 'video_report_4', label: 'Video Report 4', width: '140px' },
  { key: 'video_report_5', label: 'Video Report 5', width: '140px' },
  { key: 'text_report', label: 'Text Report', width: '200px' },
  { key: 'development', label: 'Development', width: '150px' },
  { key: 'initial_team_name', label: 'Initial Team', width: '160px' },
  { key: 'initial_team_elo', label: 'Initial Team ELO', width: '140px' },
  { key: 'initial_team_level', label: 'Initial Team Level', width: '150px' },
  { key: 'transfer_team_pts', label: 'Transfer Team Pts', width: '160px' },
  { key: 'initial_competition', label: 'Initial Competition', width: '170px' },
  { key: 'initial_competition_elo', label: 'Initial Competition ELO', width: '180px' },
  { key: 'initial_competition_level', label: 'Initial Competition Level', width: '200px' },
  { key: 'transfer_competition_pts', label: 'Transfer Competition Pts', width: '190px' },
  { key: 'initial_player_trfm_value', label: 'Initial Player TRFM Value', width: '200px' },
  { key: 'roi', label: 'ROI', width: '90px' },
