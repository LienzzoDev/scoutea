          ...
          <div className="mb-8">
            ...
            <div className="space-y-0">
              ...
              <div className="grid grid-cols-5 gap-4 py-3 border-b border-gray-100">
                ...
                <span className="text-[#6d6d6d]">
                  {getStatValue("cleanSheetsPercentage", "totalValue")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("cleanSheetsPercentage", "p90Value")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("cleanSheetsPercentage", "averageValue")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("cleanSheetsPercentage", "maximumValue")}
                </span>
              </div>
              <div className="grid grid-cols-5 gap-4 py-3">
                <span className="font-medium text-[#2e3138]">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-0">
              ...
              <div className="grid grid-cols-5 gap-4 py-3 border-b border-gray-100">
                ...
                <span className="text-[#6d6d6d]">
                  {getStatValue("offDuelsWonPercentage", "totalValue")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("offDuelsWonPercentage", "p90Value")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("offDuelsWonPercentage", "averageValue")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("offDuelsWonPercentage", "maximumValue")}
                </span>
              </div>
              <div className="grid grid-cols-5 gap-4 py-3 border-b border-gray-100">
                <span className="font-medium text-[#2e3138]">
                ...
                <span className="text-[#6d6d6d]">
                  {getStatValue("defDuelsWonPercentage", "totalValue")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("defDuelsWonPercentage", "p90Value")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("defDuelsWonPercentage", "averageValue")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("defDuelsWonPercentage", "maximumValue")}
                </span>
              </div>
              <div className="grid grid-cols-5 gap-4 py-3">
                <span className="font-medium text-[#2e3138]">
                ...
                <span className="text-[#6d6d6d]">
                  {getStatValue("aerDuelsWonPercentage", "totalValue")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("aerDuelsWonPercentage", "p90Value")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("aerDuelsWonPercentage", "averageValue")}
                </span>
                <span className="text-[#6d6d6d]">
                  {getStatValue("aerDuelsWonPercentage", "maximumValue")}
                </span>
              </div>
            </div>
          </div>
