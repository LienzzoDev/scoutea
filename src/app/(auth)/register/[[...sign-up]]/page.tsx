    ...
    <div className="min-h-screen bg-[#080F17] flex items-center justify-center p-4">
      <div className="w-full max-w-md flex flex-col items-center space-y-8">
        ...
        <div className="flex items-center justify-center">
          <div className="flex items-center space-x-4 rounded-2xl p-6 border border-white/10 shadow-none">
            <img 
              src="/sports_and_outdoors.png" 
              alt="Sports & Outdoors" 
        ...
        <div className="text-center mb-3">
          <h1 className="text-white text-lg font-semibold">Admin Register</h1>
        </div>
