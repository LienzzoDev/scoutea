      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#6d6d6d]">
            Únete a nuestra red de scouts profesionales
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-xl shadow-lg p-6 text-white">
              <div className="text-center">
                <p className="text-emerald-100 mb-1">Plan Scout Básico</p>
                <div className="flex items-baseline justify-center">
                  <span className="text-4xl font-bold">$20</span>
                  <span className="text-emerald-100 ml-1">/mes</span>
                </div>
                <p className="text-emerald-100 text-sm mt-1">
                  o $17/mes pagando anualmente
                </p>
              </div>

              <div className="mt-4 pt-4 border-t border-emerald-400">
                <p className="text-sm text-center text-emerald-100">
                  Incluye acceso a Wonderkids + Torneos<br />
                  <span className="font-semibold text-white">Opción de upgrade a Premium disponible</span>
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                ...
                Si ya eres miembro de Scoutea, puedes solicitar convertirte en Scout desde tu panel de usuario.
              </p>
            </div>
          </div>
                ...
                <SignUp
                  ...
                  appearance={{
                    ...
                    elements: {
                      ...
                      formButtonPrimary: "bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 h-12",
                      formFieldInput: "border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-transparent h-12",
