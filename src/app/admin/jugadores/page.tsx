...
export default function JugadoresPage() {
  ...
  const filteredPlayers = playersFilteredByFilters.filter(
    player =>
      player.player_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
      (player.complete_player_name &&
        player.complete_player_name.toLowerCase().includes(searchTerm.toLowerCase())) ||
              ...
              {filteredPlayers.map(player => (
                ...
                >
                  <div className='flex items-center space-x-3'>
                    ...
                    <div>
                      <div
                        className='font-medium text-[#D6DDE6] cursor-pointer hover:text-[#FF5733]'
                      ...
                      {player.agency && (
                        <div className='text-xs text-slate-500'>Agente: {player.agency}</div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className='text-slate-300'>
                    ...
                    {player.height && (
                      <div className='text-xs text-slate-400'>{player.height}cm</div>
                    )}
                    {player.foot && <div className='text-xs text-slate-400'>{player.foot}</div>}
                  </div>
