 ...
 */
export async function GET(request: NextRequest): Promise<NextResponse<PlayerStats | { error: string }>> {
  try {
 ...
 */
export async function POST(request: NextRequest): Promise<NextResponse<PlayerStats | { error: string }>> {
  try {
