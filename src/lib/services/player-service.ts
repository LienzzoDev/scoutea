...
export class PlayerService {
  ...
  private static mapPrismaToPlayer(player: Jugador): Player {
    return {
      ...
      video: player.video,
      video_report_1: player.video_report_1,
      video_report_2: player.video_report_2,
      video_report_3: player.video_report_3,
      video_report_4: player.video_report_4,
      video_report_5: player.video_report_5,
      text_report: player.text_report,
      ...
      initial_player_trfm_value: player.initial_player_trfm_value,
      initial_trfm_value_date: player.initial_trfm_value_date,
      initial_team_name: player.initial_team_name,
      initial_team_level: player.initial_team_level,
      initial_team_elo: player.initial_team_elo,
      initial_competition: player.initial_competition,
      initial_competition_level: player.initial_competition_level,
      initial_competition_elo: player.initial_competition_elo,
      initial_age: player.initial_age,
      transfer_team_pts: player.transfer_team_pts,
      transfer_competition_pts: player.transfer_competition_pts,
      roi: player.roi,
